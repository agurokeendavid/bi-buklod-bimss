...
If the documentation and implementation disagree, do not silently guess. Preserve existing behavior unless the task explicitly changes it, and update documentation when a design decision changes.
